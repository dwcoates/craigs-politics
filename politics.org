...
#+BEGIN_SRC ipython :session :file ./py6320jfT.png :exports both
...
#+BEGIN_SRC ipython :session :file . :tangle ./politics.py
...
#+BEGIN_SRC ipython ipython :session :file . :tangle ./politics.py
...
#+BEGIN_SRC ipython :session :file ./py63203mB.png :exports both
...
#+BEGIN_SRC ipython :session :file ./py6320H0c.png :exports both
...
#+BEGIN_SRC ipython :session :file ./py6320I8X.png :exports both
l
#+END_SRC
...
#+BEGIN_SRC ipython :session :file ./py6320U3u.png :exports both
...
#+END_SRC
**** word cloud
#+BEGIN_SRC ipython :session :file ./py6320RCC.png :exports both
from os import path
...
* historgrams
#+BEGIN_SRC ipython :session :file ./py6320JLH.png :exports both
  pat = state_usage.sort_values("patronage", ascending=True)
  x = np.arange(len(pat))
