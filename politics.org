...
titles and dates, as well as corresponding geographical
designation. To keep it simple, these are all stored together as rows
in a csv file. 
** Grab CL Data  :ignore:
...
manhattan, brooklyn, queens, bronx, staten island, new jersey, long island, westchester,
and fairfield. This is ~6.5% the usage rate of Denver
:END:
...
following is and effort to support the introduction of this blog post.
** Words :ignore:
