...
<li><a href="#sec-4-3-2">4.3.2. Normalized Patronage</a></li>
</ul>
</li>
</ul>
</li>
...
# Preparing Data<a id="sec-2" name="sec-2"></a>

## Grab Data<a id="sec-2-1" name="sec-2-1"></a>
...
## U.S. Census 2010<a id="sec-2-2" name="sec-2-2"></a>
...
### Geo Keys<a id="sec-2-2-1" name="sec-2-2-1"></a>
...
### Census Data<a id="sec-2-2-2" name="sec-2-2-2"></a>
...
## U.S. 2016 Election<a id="sec-2-3" name="sec-2-3"></a>
...
## Preprocess Data<a id="sec-2-4" name="sec-2-4"></a>
...
# Unicode<a id="sec-3" name="sec-3"></a>
...
## Pennsylvania<a id="sec-3-1" name="sec-3-1"></a>
...
### Colorado<a id="sec-3-1-1" name="sec-3-1-1"></a>

    print "\n\n{0} regions in Colorado".format(usa[usa['state'] == "Colorado"]["region"].nunique())

# State Popularity<a id="sec-4" name="sec-4"></a>

## Usage<a id="sec-4-1" name="sec-4-1"></a>
...
## Normalization<a id="sec-4-2" name="sec-4-2"></a>
...
## Analysis<a id="sec-4-3" name="sec-4-3"></a>

### Patronage<a id="sec-4-3-1" name="sec-4-3-1"></a>
...
![img](/home/dodge/workspace/craig-politics/py6320LXp.png)

    p2 = pat.normalized
    
    plt.bar(x, p2)

![img](/home/dodge/workspace/craig-politics/py6320lr1.png)
...
![img](/home/dodge/workspace/craig-politics/py6320Yhv.png)

### Normalized Patronage<a id="sec-4-3-2" name="sec-4-3-2"></a>
